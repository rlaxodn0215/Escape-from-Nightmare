local roomObjects = {
    child_room = {
        ...
        { id = "child_bed_hide", type = "hide_spot", hitbox = { x = 274, y = 430, w = 212, h = 96 } },
    ...
    second_floor_hallway = {
        ...
        { id = "second_floor_hallway_closet_hide", type = "hide_spot", hitbox = { x = 1038, y = 424, w = 130, h = 86 } },
    ...
    master_bedroom = {
        ...
        { id = "master_bed_hide", type = "hide_spot", hitbox = { x = 318, y = 436, w = 226, h = 88 } },
        { id = "master_wardrobe_hide", type = "hide_spot", hitbox = { x = 936, y = 218, w = 86, h = 286 } },
    ...
    dressing_room = {
        ...
        { id = "dressing_closet_hide", type = "hide_spot", hitbox = { x = 872, y = 206, w = 152, h = 300 } },
    ...
    guest_room = {
        ...
        { id = "guest_bed_hide", type = "hide_spot", hitbox = { x = 688, y = 432, w = 254, h = 92 } },
    ...
    second_floor_bathroom = {
        ...
        { id = "second_floor_bathroom_tub_hide", type = "hide_spot", hitbox = { x = 834, y = 408, w = 222, h = 100 } },
    ...
    study = {
        ...
        { id = "study_desk_hide", type = "hide_spot", hitbox = { x = 314, y = 424, w = 192, h = 92 } },
    ...
    first_floor_hallway = {
        ...
        { id = "first_floor_hallway_cabinet_hide", type = "hide_spot", hitbox = { x = 1028, y = 414, w = 130, h = 96 } },
    ...
    living_room = {
        ...
        { id = "living_room_curtain_hide", type = "hide_spot", hitbox = { x = 826, y = 180, w = 156, h = 338 } },
    ...
    kitchen = {
        ...
        { id = "kitchen_counter_hide", type = "hide_spot", hitbox = { x = 328, y = 426, w = 174, h = 90 } },
    ...
    first_floor_bathroom = {
        ...
        { id = "first_floor_bathroom_tub_hide", type = "hide_spot", hitbox = { x = 822, y = 408, w = 228, h = 100 } },
    ...
    family_photo_room = {
        ...
        { id = "photo_room_cabinet_hide", type = "hide_spot", hitbox = { x = 990, y = 230, w = 112, h = 276 } },
    ...
    basement_storage = {
        ...
        { id = "basement_storage_shelf_hide", type = "hide_spot", hitbox = { x = 336, y = 230, w = 154, h = 278 } },
        { id = "basement_storage_barrel_hide", type = "hide_spot", hitbox = { x = 814, y = 410, w = 150, h = 98 } },
    ...
    attic_main = {
        ...
        { id = "attic_main_trunk_hide", type = "hide_spot", hitbox = { x = 318, y = 418, w = 184, h = 94 } },
    ...
    attic_toy_storage = {
        ...
        { id = "attic_toy_shelf_hide", type = "hide_spot", hitbox = { x = 308, y = 414, w = 150, h = 98 } }
    },
    attic_album_storage = {
        ...
        { id = "attic_album_chest_hide", type = "hide_spot", hitbox = { x = 842, y = 412, w = 178, h = 96 } }
    }
}
