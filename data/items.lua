local items = {
    torn_drawing_fragment = {
        ...
        icon = "assets/images/items/item_torn_drawing_fragment.png",
        type = "clue_item",
    ...
    study_safe_clue = {
        ...
        icon = "assets/images/items/item_study_safe_clue.png",
        type = "clue_item",
    ...
    fuse_holder = {
        id = "fuse_holder",
        name = "Fuse Holder",
        icon = "assets/images/items/item_electric_part.png",
    ...
    fuse = {
        id = "fuse",
        name = "Fuse",
        icon = "assets/images/items/item_fuse.png",
        type = "mechanical_part",
    ...
    broken_hand_mirror = {
        ...
        icon = "assets/images/items/item_broken_hand_mirror.png",
        type = "altar_object",
    ...
    small_doll = {
        id = "small_doll",
        name = "Small Doll",
        icon = "assets/images/items/item_small_doll.png",
        type = "altar_object",
    ...
    old_keychain = {
        id = "old_keychain",
        name = "Old Keychain",
        icon = "assets/images/items/item_old_keychain.png",
        type = "altar_object",
    ...
    old_necklace = {
        id = "old_necklace",
        name = "Old Necklace",
        icon = "assets/images/items/item_old_necklace.png",
        type = "altar_object",
    ...
    symbol_fragment = {
        ...
        icon = "assets/images/items/item_symbol_fragment.png",
        type = "clue_item",
        acquired_from = "attic_toy_box",
        used_in = { "basement_altar" },
    ...
    front_door_key = {
        id = "front_door_key",
        name = "Front Door Key",
        icon = "assets/images/items/item_front_door_key.png",
        type = "key_item",
