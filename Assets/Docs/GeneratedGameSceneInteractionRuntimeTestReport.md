...
- Generated At: 2026-05-29 23:14:18
...
|---:|---|---|---|---|---:|
| 1 | Navigation | RotateLeft/RotateRight | Pass | RotateRight moved to Bedroom_Right and RotateLeft returned to Bedroom_Front. | 1.99s |
| 2 | Door Buttons | Door_Bedroom_SecondFloorHallway | Pass | Door click moved to SecondFloorHallway/SecondFloorHallway_Back. | 0.10s |
...
| 6 | Door Buttons | Door_SecondFloorHallway_Study | Pass | Door click moved to Study/Study_Front. | 0.10s |
| 7 | Door Buttons | Door_Study_SecondFloorHallway | Pass | Door click moved to SecondFloorHallway/SecondFloorHallway_Front. | 0.10s |
| 8 | Door Buttons | Door_SecondFloorHallway_LivingRoom | Pass | Door click moved to LivingRoom/LivingRoom_Back. | 0.10s |
| 9 | Door Buttons | Door_LivingRoom_SecondFloorHallway | Pass | Door click moved to SecondFloorHallway/SecondFloorHallway_Front. | 0.10s |
...
| 14 | Door Buttons | Door_BasementStorage_LockedRoom | Pass | Door click moved to LockedRoom/LockedRoom_Front. | 0.11s |
| 15 | Door Buttons | Door_LockedRoom_BasementStorage | Pass | Door click moved to BasementStorage/BasementStorage_Right. | 0.10s |
| 16 | Door Buttons | Door_LivingRoom_Entrance | Pass | Door click moved to Entrance/Entrance_Front. | 0.11s |
| 17 | Door Buttons | Door_Entrance_LivingRoom | Pass | Door click moved to LivingRoom/LivingRoom_Front. | 0.10s |
| 18 | Puzzle Buttons | Puzzle_Bedroom_01 | Pass | Scene button opened puzzle UI: PuzzleUI_BedroomNumberCode. | 0.21s |
| 19 | Puzzle Buttons | Puzzle_LivingRoom_01 | Pass | Scene button opened puzzle UI: PuzzleUI_LivingRoomItemUse. | 0.21s |
| 20 | Puzzle Buttons | Puzzle_ChildRoom_01 | Pass | Scene button opened puzzle UI: PuzzleUI_ChildRoomCardOrder. | 0.20s |
| 21 | Puzzle Buttons | Puzzle_Study_01 | Pass | Scene button opened puzzle UI: PuzzleUI_StudyBookOrder. | 0.21s |
...
| 24 | Puzzle Buttons | Puzzle_BasementStorage_01 | Pass | Scene button opened puzzle UI: PuzzleUI_BasementPowerDevice. | 0.22s |
| 25 | Puzzle Buttons | Puzzle_LockedRoom_01 | Pass | Scene button opened puzzle UI: PuzzleUI_LockedRoomFinal. | 0.20s |
...
| 28 | ExamineImage Buttons | LivingRoomEntranceCodeClue | Pass | Clue panel opened from scene button. | 0.11s |
...
| 33 | ExamineImage Buttons | BasementPowerPatternClue | Pass | Clue panel opened from scene button. | 0.10s |
| 34 | ExamineImage Buttons | BasementClueImage | Pass | Clue panel opened from scene button. | 0.10s |
...
| 37 | HidePoint Buttons | HidePoint_Bedroom_Closet | Pass | HidePoint entered and ForceExitHidePoint restored state. | 0.11s |
| 38 | FinalDoor | FinalDoor_FrontDoorKey | Pass | FinalDoor reached Ending through scene button flow. | 0.31s |
| 39 | Full Scene Click Route | BedroomToEnding | Pass | Scene buttons completed the full route and reached Ending. | 6.06s |
